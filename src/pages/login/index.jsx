          ...
          <Row>
            ...
            <Col span={12}>
              <div className="login-form-box">
                <h1 style={{ fontSize: '24px', color: colorPrimaryText }}>wumusenlin</h1>
                <Divider />
                <h2>账密登录</h2>
                <br />
                <div className="ipt-con">
                  <Input
                    size="large"
                    prefix={<UserOutlined style={{ color: colorPrimaryText }} />}
                    placeholder="账号"
                    value={account}
                    onChange={(e) => {
                ...
                <div className="ipt-con">
                  <Input.Password
                    prefix={<LockOutlined style={{ color: colorPrimaryText }} />}
                    size="large"
                    placeholder="密码"
                    value={password}
                    onChange={(e) => {
